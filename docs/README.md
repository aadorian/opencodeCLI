...
| [Open Source Examples](./discussions/open-source-examples.md) | [Discussion hub](https://github.com/aadorian/opencodeCLI/discussions/33) for public workflows and configs |
